...
class StatisticsActivity : AppCompatActivity() {
    ...
    private val statisticsPresenter: StatisticsContract.Presenter by injector.instance()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val statisticsFragment = (supportFragmentManager.findFragmentById(R.id.contentFrame) as? StatisticsFragment) ?: run {
